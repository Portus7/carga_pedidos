...
class Precios(models.Model):
    articuloobj = models.ForeignKey('Producto', on_delete=models.SET_NULL, null=True)
    canalobj = models.ForeignKey('Canal', on_delete=models.SET_NULL, null=True)
    precio = models.FloatField()
    fecha_vigencia = models.DateField()

class Orders(models.Model):
    pedido_numero = models.BigIntegerField(unique=True)
    pdvobj = models.ForeignKey(Cliente, on_delete=models.SET_NULL, null=True)
    ...
    anulado_040_por_gecos = models.CharField(max_length=255, null=True)

class OrdersDetail(models.Model):
    orderobj = models.ForeignKey(Orders, on_delete=models.SET_NULL, null=True)
    artobj = models.ForeignKey(Producto, on_delete=models.SET_NULL, null=True)
